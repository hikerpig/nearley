(function(root, factory) {
    ...
    function serializeParserOptions(parser) {
        var ret = "{";
        var segs = [];

        const skipUnmatchSymbolstring = parser.skipUnmatchSymbols.map(function(token) {
            return serializeSymbol(token);
        }).join(',');
        segs.push("skipUnmatchSymbols: [" + skipUnmatchSymbolstring + "]");
    ...
    generate.js = generate._default = generate.javascript = function (parser, exportName) {
        ...
        output += "  , ParserOptions: " + serializeParserOptions(parser) + "\n";
        output += "}\n";
    ...
    generate.module = generate.esmodule = function (parser, exportName) {
        ...
        output += "let ParserOptions = " + serializeParserOptions(parser) + ";\n";
    ...
    generate.ts = generate.typescript = function (parser, exportName) {
        ...
        output += "\n";
        output += "type NearleyParserOptions = {\n";
        ...
        output += "  ParserOptions: NearleyParserOptions;\n";
        output += "};\n";
        output += "\n";
