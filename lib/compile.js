        ...
        for (var i = 0; i < structure.length; i++) {
            ...
            if (productionRule.body) {
                ...
                if (opts.alreadycompiled.indexOf(path) === -1) {
                    ...
                    result.skipUnmatchSymbols = result.skipUnmatchSymbols.concat(c.skipUnmatchSymbols);
            ...
            } else if (productionRule.skipUnmatchSymbol) {
                const resultToken = buildToken('skipUnmatchSymbols', { token: productionRule.skipUnmatchSymbol }, {})
                result.skipUnmatchSymbols.push(resultToken)
            } else {
